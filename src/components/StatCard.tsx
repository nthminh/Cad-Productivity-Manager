        ...
        <div>
          ...
          {trend && (
            <div className={cn(
              ...
              <span className="text-slate-400 font-normal hidden sm:inline-block">so với tháng trước</span>
            </div>
          )}
        </div>
        <div className={cn("p-2 md:p-3 rounded-lg md:rounded-xl border", colorClasses[color])}>
